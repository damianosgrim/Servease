 ...
 * @author User
 */
public class addWaiterScreen extends javax.swing.JFrame {

    /**
     * Creates new form addWaiterScreen
     */
    public addWaiterScreen() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addWaiterScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new addWaiterScreen().setVisible(true);
            }
        });
    }
